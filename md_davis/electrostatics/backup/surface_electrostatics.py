...
def main():
    ...
    parser.add_argument('-v', '--vertices', metavar='filename.vert',
                        help='Input file containing vertices generated by MSMS')
    ...
    if args.surface:
        ...
        # remove this subprocess run with a function
        subprocess.run(['python', f'{this_script_path}/vert2pdb.py', vert_file, args.pdb, '-o', surface_file])
